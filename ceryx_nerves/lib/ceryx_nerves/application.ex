defmodule CeryxNerves.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: CeryxNerves.Supervisor]
  ...
  def children("host") do
    [
      # Starts a worker by calling: CeryxNerves.Worker.start_link(arg)
      # {CeryxNerves.Worker, arg},
    ]
  end
