defmodule RoboticaUi.Schedule do
  ...
  def register(pid) do
    GenServer.call(:ui_schedule, {:register, pid})
  end

  def set_schedule(schedule) do
    GenServer.call(:ui_schedule, {:set_schedule, schedule})
  end

  def get_schedule() do
    GenServer.call(:ui_schedule, {:get_schedule})
  end

  def get_tasks_by_id(id) do
    GenServer.call(:ui_schedule, {:get_tasks_by_id, id})
  end
